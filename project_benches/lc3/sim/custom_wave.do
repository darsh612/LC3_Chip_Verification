...
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/go
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/clock_i
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/reset_i
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/enable_updatePC_i
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/enable_fetch_i
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/taddr_i
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/br_taken_i
add wave -noupdate /hdl_top/fetch_agent_fetch_in_mon_bfm/proxy
add wave -noupdate /hdl_top/fetch_agent_fetch_out_mon_bfm/clock_i
add wave -noupdate /hdl_top/fetch_agent_fetch_out_mon_bfm/reset_i
add wave -noupdate /hdl_top/fetch_agent_fetch_out_mon_bfm/npc_i
add wave -noupdate /hdl_top/fetch_agent_fetch_out_mon_bfm/pc_i
add wave -noupdate /hdl_top/fetch_agent_fetch_out_mon_bfm/instrmem_rd_i
add wave -noupdate /hdl_top/fetch_agent_fetch_out_mon_bfm/proxy
add wave -noupdate /hdl_top/fetch_agent_fetch_out_mon_bfm/go
add wave -noupdate /hdl_top/decode_agent_in_mon_bfm/clock_i
add wave -noupdate /hdl_top/decode_agent_in_mon_bfm/reset_i
add wave -noupdate /hdl_top/decode_agent_in_mon_bfm/enable_decode_i
add wave -noupdate /hdl_top/decode_agent_in_mon_bfm/instr_dout_i
add wave -noupdate /hdl_top/decode_agent_in_mon_bfm/npc_in_i
add wave -noupdate /hdl_top/decode_agent_in_mon_bfm/proxy
add wave -noupdate /hdl_top/decode_agent_in_mon_bfm/go
add wave -noupdate /hdl_top/decode_agent_out_mon_bfm/ir_i
add wave -noupdate /hdl_top/decode_agent_out_mon_bfm/npc_out_i
add wave -noupdate /hdl_top/decode_agent_out_mon_bfm/e_control_i
add wave -noupdate /hdl_top/decode_agent_out_mon_bfm/w_control_i
add wave -noupdate /hdl_top/decode_agent_out_mon_bfm/m_control_i
add wave -noupdate /hdl_top/control_agent_in_mon_bfm/complete_instr_i
add wave -noupdate /hdl_top/control_agent_in_mon_bfm/complete_data_i
add wave -noupdate /hdl_top/control_agent_in_mon_bfm/IR_i
add wave -noupdate /hdl_top/control_agent_in_mon_bfm/psr_i
add wave -noupdate /hdl_top/control_agent_in_mon_bfm/IR_Exec_i
add wave -noupdate /hdl_top/control_agent_in_mon_bfm/IMem_dout_i
add wave -noupdate /hdl_top/control_agent_in_mon_bfm/NZP_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/enable_updatePC_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/enable_fetch_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/enable_decode_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/enable_execute_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/enable_writeback_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/bypass_alu_1_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/bypass_alu_2_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/bypass_mem_1_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/bypass_mem_2_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/mem_state_i
add wave -noupdate /hdl_top/control_agent_out_mon_bfm/br_taken_i
add wave -noupdate /hdl_top/execute_agent_in_bus/E_control
add wave -noupdate /hdl_top/execute_agent_in_bus/bypass_alu_1
add wave -noupdate /hdl_top/execute_agent_in_bus/enable_execute
add wave -noupdate /hdl_top/execute_agent_in_bus/bypass_alu_2
add wave -noupdate /hdl_top/execute_agent_in_bus/bypass_mem_1
add wave -noupdate /hdl_top/execute_agent_in_bus/bypass_mem_2
add wave -noupdate /hdl_top/execute_agent_in_bus/IR
add wave -noupdate /hdl_top/execute_agent_in_bus/npc_in
add wave -noupdate /hdl_top/execute_agent_in_bus/Mem_Control_in
add wave -noupdate /hdl_top/execute_agent_in_bus/W_Control_in
add wave -noupdate /hdl_top/execute_agent_in_bus/VSR1
add wave -noupdate /hdl_top/execute_agent_in_bus/VSR2
add wave -noupdate /hdl_top/execute_agent_in_bus/Mem_Bypass_Val
add wave -noupdate /hdl_top/execute_agent_out_bus/aluout
add wave -noupdate /hdl_top/execute_agent_out_bus/W_Control_out
add wave -noupdate /hdl_top/execute_agent_out_bus/Mem_Control_out
add wave -noupdate /hdl_top/execute_agent_out_bus/M_Data
add wave -noupdate /hdl_top/execute_agent_out_bus/dr
add wave -noupdate /hdl_top/execute_agent_out_bus/sr1
add wave -noupdate /hdl_top/execute_agent_out_bus/sr2
add wave -noupdate /hdl_top/execute_agent_out_bus/pcout
add wave -noupdate /hdl_top/execute_agent_out_bus/IR_Exec
add wave -noupdate /hdl_top/execute_agent_out_bus/NZP
add wave -noupdate /hdl_top/memaccess_agent_in_bus/mem_state
add wave -noupdate /hdl_top/memaccess_agent_in_bus/M_Control
add wave -noupdate /hdl_top/memaccess_agent_in_bus/M_Data
add wave -noupdate /hdl_top/memaccess_agent_in_bus/M_addr
add wave -noupdate /hdl_top/memaccess_agent_in_bus/DMem_dout
add wave -noupdate /hdl_top/memaccess_agent_out_bus/DMem_addr
add wave -noupdate /hdl_top/memaccess_agent_out_bus/Dmem_din
add wave -noupdate /hdl_top/memaccess_agent_out_bus/DMem_rd
add wave -noupdate /hdl_top/memaccess_agent_out_bus/memout
add wave -noupdate /hdl_top/writeback_agent_in_bus/enable_writeback
add wave -noupdate /hdl_top/writeback_agent_in_bus/npc
add wave -noupdate /hdl_top/writeback_agent_in_bus/W_control_in
add wave -noupdate /hdl_top/writeback_agent_in_bus/aluout
add wave -noupdate /hdl_top/writeback_agent_in_bus/pcout
add wave -noupdate /hdl_top/writeback_agent_in_bus/memout
add wave -noupdate /hdl_top/writeback_agent_in_bus/sr1
add wave -noupdate /hdl_top/writeback_agent_in_bus/sr2
add wave -noupdate /hdl_top/writeback_agent_in_bus/dr
add wave -noupdate /hdl_top/writeback_agent_out_bus/VSR1
add wave -noupdate /hdl_top/writeback_agent_out_bus/VSR2
add wave -noupdate /hdl_top/writeback_agent_out_bus/psr
add wave -noupdate /hdl_top/writeback_agent_out_bus/enable_writeback
add wave -noupdate /hdl_top/inst_mem_bus/PC
add wave -noupdate /hdl_top/inst_mem_bus/instrmem_rd
add wave -noupdate /hdl_top/inst_mem_bus/instr_dout
add wave -noupdate /hdl_top/inst_mem_bus/complete_instr
add wave -noupdate /hdl_top/data_mem_bus/complete_data
add wave -noupdate /hdl_top/data_mem_bus/Data_dout
add wave -noupdate /hdl_top/data_mem_bus/Data_din
add wave -noupdate /hdl_top/data_mem_bus/Data_rd
add wave -noupdate /hdl_top/data_mem_bus/Data_addr
